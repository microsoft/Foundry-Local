...
describe('Chat Client Tests', () => {
    ...
    it('should perform tool calling chat completion (non-streaming)', async function() {
        ...
        try {
            ...
            // If the model called the tool, verify the tool call details.
            if (response.choices[0].finish_reason === 'tool_calls') {
                ...
                // Model responded directly — verify it at least produced a response with the answer
    ...
    it('should perform tool calling chat completion (streaming)', async function() {
        ...
        try {
            ...
            if (lastToolCallChunk) {
                // Tool call path — verify tool call details
                ...
                // Model responded directly — verify it produced a response with the answer
                expect(fullResponse).to.include('42');
            }
        } finally {
            await model.unload();
