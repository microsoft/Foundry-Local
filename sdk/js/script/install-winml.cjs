...
const { ORT_NIGHTLY_FEED, runInstall } = require('./install-utils.cjs');
...
const ARTIFACTS = [
    ...
    { name: 'Microsoft.ML.OnnxRuntime.Foundry', version: deps.onnxruntime.version, feed: ORT_NIGHTLY_FEED },
