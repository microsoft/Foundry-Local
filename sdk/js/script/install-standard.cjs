...
const ARTIFACTS = [
    ...
    { name: os.platform() === 'linux' ? 'Microsoft.ML.OnnxRuntime.Gpu.Linux' : 'Microsoft.ML.OnnxRuntime.Foundry', version: '1.25.0-dev-20260212-0905-d7f32e2595', feed: ORT_NIGHTLY_FEED, nightly: useNightly },
