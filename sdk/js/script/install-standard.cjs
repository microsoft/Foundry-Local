...
const ARTIFACTS = [
    { name: 'Microsoft.AI.Foundry.Local.Core', version: '0.9.0-dev-20260325T055742-33ebe7c', feed: ORT_NIGHTLY_FEED, nightly: useNightly },
    { name: os.platform() === 'linux' ? 'Microsoft.ML.OnnxRuntime.Gpu.Linux' : 'Microsoft.ML.OnnxRuntime.Foundry', version: '1.25.0-dev-20260212-0905-d7f32e2595', feed: NUGET_FEED, nightly: false },
