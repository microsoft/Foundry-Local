...
<div class="container mx-auto px-4 py-8">
	<div class="mb-8 text-center">
		<h1 class="mb-4 text-4xl font-bold">Foundry Local Models</h1>
	...
	<div class="mb-8 rounded-lg bg-white p-6 shadow-lg dark:bg-gray-800">
		<div class="mb-4">
			<h2 class="mb-2 text-lg font-semibold">Filter & Search Models</h2>
		...
		<div class="mb-4 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-5">
			...
			<div class="lg:col-span-2">
				<label class="mb-2 block text-sm font-medium" for="search-models">Search Models</label>
				<div class="relative">
					<input
						id="search-models"
						type="text"
			...
			<div class="flex flex-col">
				<div class="mb-2 block text-sm font-medium">Filter by Execution Device</div>
				<div class="flex flex-1 gap-2" role="group" aria-label="Filter by Execution Device">
					{#each availableDevices as device}
						<button
							type="button"
							class="btn h-full min-h-[3rem] flex-1"
			...
			<!-- Acceleration Filter -->
			<div>
				<label class="mb-2 block text-sm font-medium" for="acceleration-filter"
			...
			<!-- Model Family Filter -->
			<div>
				<label class="mb-2 block text-sm font-medium" for="family-filter"
		...
		<div class="flex flex-wrap items-center justify-between gap-4">
			<div class="flex items-center gap-4">
				<div>
					<label class="mb-1 block text-sm font-medium" for="sort-by">Sort by</label>
				...
				<div>
					<label class="mb-1 block text-sm font-medium" for="sort-order">Order</label>
	...
	{#if !loading && !error}
		{#if paginatedModels.length > 0}
			<div
				class="mb-8 grid grid-cols-1 gap-6 transition-opacity duration-300 md:grid-cols-2 lg:grid-cols-3"
				class:opacity-75={searchTerm !== debouncedSearchTerm}
			>
				{#each paginatedModels as model (model.alias)}
					<div
						class="card bg-base-100 flex h-full flex-col border border-gray-200 shadow-xl transition-shadow duration-200 hover:shadow-2xl dark:border-gray-700"
					>
						<div class="card-body flex flex-col p-5">
							<!-- Header with title and publisher -->
							<div class="mb-3">
								<h3 class="card-title mb-1 text-lg font-semibold">{model.displayName}</h3>
							...
							<div
								class="flex flex-col gap-2 border-t border-gray-200 pt-3 text-xs text-gray-500 dark:border-gray-700"
							>
